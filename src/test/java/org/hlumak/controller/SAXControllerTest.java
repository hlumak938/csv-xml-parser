...
public class SAXControllerTest {
    private final ArticleController saxController = new ArticleController(new ArticleService(new ArticleConvertor(), new SystemFileConnector()));

    private SAXControllerTest() {
        saxController.setConvertor(new ArticleSAXConvertorStrategy());
    }
